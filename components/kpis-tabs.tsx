    ...
    >
      {KPI_OPTIONS.map(({ label, value, formatter }) => (
        <button
          ...
          className="relative cursor-pointer p-6 md:p-9 text-left md:text-center text-secondary hover:bg-primary/90 transition-colors sm:state-active:border-b-4 sm:state-active:border-primary state-active:text-primary sm:mb-2"
        ...
        >
          <div className="flex flex-col gap-2 w-fit md:mx-auto">
            ...
            <span
              className="text-[#0761d1] text-left font-normal"
              aria-hidden={true}
            >
